...
<body>
    ...
    <div class="invoice">
        ...
        <img src="{{ public_path('images/logos/logo.png') }}" alt="Logo da Agência" class="logo-agencia">
            ...
            <h2><i><span class="titulo">Accommodation</span> Voucher</i></h2>
    </div>
            ...
            <table width="100%">
                ...
                <tbody>
                    <tr style="background-color: #f2f2f2;">
                        <td colspan="7" style="color: green; font-size: 17px; font-weight: bold;">
                ...
                <thead>
                    <tr>
                        ...
                        <th colspan="2">Traveler(s) Name(s)</th> 
                        <th>No. of Room</th>    
                        <th>No. of Night(s)</th>
                        <th>Room Type</th>
                        <th>Category </th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="centro">
                            @if (!empty($resposta['activity']['rooms']))
                            @foreach ($resposta['activity']['rooms'] as $room)
                            {{ $room['numRoom'] }}<br>
                            @endforeach
                            @else
                        ...
                        <td class="centro">
                            {{ isset($resposta['activity']['numNoite']) ? htmlspecialchars($resposta['activity']['numNoite']) : 'N/A' }}
                        </td>
                        <td>
                             @if (!empty($resposta['activity']['rooms']))
                            @foreach ($resposta['activity']['rooms'] as $room)
                ...
                <thead>
                 ...
                 <tbody>
                    <tr>
                        ...
                        <td>{{ $resposta['activity']['rooms'][0]['checkinDate'] }}</td>
                        <td></td>
                        <td>After 14h00</td>
                        <td>{{ $resposta['activity']['rooms'][0]['checkoutDate'] }}</td>
                        <td>Before 12h00</td>
                        <td>
    ...
    <div class="body">
         ...
         <thead>
                ...
                <tbody>
                <tr>
                    <td colspan="6" class="rodape">Accommodation address:</td>
                    <td></td>
                </tr>
                <tr>
                    <td class="rodape">Accommodation Contact Number:</td>
                    <td></td>
                </tr>
                <tr>
                    <td class="rodape">Main Included amenities:</td>
                    <td></td>
                </tr>
                <tr>
                    <td class="rodape">Main Excluded Amenities:</td>
                    <td></td>
                </tr>
                <tr>
                    <td class="rodape">Is there a fee to pay when checking in?</td>
                    <td></td>
                </tr>
                <tr>
                    <td class="rodape">Number of Extra bad:</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
